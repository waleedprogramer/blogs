...
function About() {
  return (
    <>
      ...
      <div className="gap-16 flex flex-col lg:flex-row px-10  items-center text-text">
      ...
      <div className="gap-16 flex flex-col-reverse lg:flex-row px-10   items-center text-text">
        <div className="content w-full lg:w-1/2 text-center lg:text-left">
          <div className="flex items-center gap-2 justify-center lg:justify-start">
            <span className="py-2 px-2 bg-dark rounded-full"></span>
